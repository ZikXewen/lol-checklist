...
list.forEach(function (_a) {
    ...
    newEl.addEventListener('click', function (e) {
        var target = e.target;
        var id = list.findIndex(function (_a) {
            var name = _a.name;
            return name === (target === null || target === void 0 ? void 0 : target.innerText);
        });
        list[id].checked = !list[id].checked;
        localStorage.setItem('champions-list', JSON.stringify(list));
        target === null || target === void 0 ? void 0 : target.classList.toggle('checked');
    });
